...
__attribute__((section("__versions"))) = {
	...
	{ 0x9f46c834, __VMLINUX_SYMBOL_STR(mtd_device_parse_register) },
	{ 0x5fb767be, __VMLINUX_SYMBOL_STR(nand_scan_tail) },
	{ 0xeccfab79, __VMLINUX_SYMBOL_STR(nand_scan_ident) },
	...
	{ 0xacbef77a, __VMLINUX_SYMBOL_STR(nand_release) },
